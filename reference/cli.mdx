...
| `logbrew setup --create-project [--json]` | Show project creation discovery help. Help-only in v0.1.25. |
...
| `logbrew projects [--json]` | Show project discovery help. Help-only in v0.1.25. |
| `logbrew project [--json]` | Alias for project discovery help. Help-only in v0.1.25. |
| `logbrew projects create <name> [--json]` | Show project creation discovery help. Help-only in v0.1.25. |
...
| `logbrew usage [--json]` | Show usage discovery help. Help-only in v0.1.25. |
| `logbrew account usage [--json]` | Show account usage discovery help. Help-only in v0.1.25. |
...
CLI v0.1.25 exposes project creation and account usage commands as discovery
