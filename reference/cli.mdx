...
| `logbrew setup --create-project [--json]` | Show project creation discovery help. Help-only in v0.1.24. |
...
| `logbrew projects [--json]` | Show project discovery help. Help-only in v0.1.24. |
| `logbrew project [--json]` | Alias for project discovery help. Help-only in v0.1.24. |
| `logbrew projects create <name> [--json]` | Show project creation discovery help. Help-only in v0.1.24. |
...
| `logbrew usage [--json]` | Show usage discovery help. Help-only in v0.1.24. |
| `logbrew account usage [--json]` | Show account usage discovery help. Help-only in v0.1.24. |
...
CLI v0.1.24 exposes project creation and account usage commands as discovery
