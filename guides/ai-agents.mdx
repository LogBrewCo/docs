...
<Steps>
  <Step title="Check access and project state">
    ...
    In CLI v0.1.15, `projects` and `usage` are help-only discovery commands.
    They do not create projects, persist setup state, calculate usage locally,
    or print SDK or ingest configuration. If authentication is missing, run
