...
The public install surfaces track CLI v0.1.15 across GitHub Releases,
...
## Discover project and usage flows

CLI v0.1.15 includes project and usage discovery commands for first-run setup
and agents. These commands are help-only today: they do not create projects, do
not calculate usage from local files, do not persist setup state, and do not
print SDK or ingest configuration.
