...
Use the canonical values in dashboards, CLI output, API output, and examples.
SDKs may accept common aliases as input compatibility, but unknown severity or
level values are rejected.
