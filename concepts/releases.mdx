...
Every telemetry envelope in LogBrew must include a non-empty `release`. A
release is the code version that emitted telemetry, such as `api@1.2.3`,
`ios@2026.06.01`, or a git SHA.
